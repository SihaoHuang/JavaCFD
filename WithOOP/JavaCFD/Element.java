public class Element{
    ...
    public void addHere(double val){
      here += val;
    }
    public void addUp(double up){
      this.up += up;
    }
    public void addDown(double down){
      this.down += down;
    }
    ...
    public void addNorthEast(double northEast){
      this.northEast += northEast;
    }
    public void addNorthWest(double northWest){
      this.northWest += northWest;
    }
    public void addSouthEast(double southEast){
      this.southEast += southEast;
    }
    public void addSouthWest(double southWest){
      this.southWest += southWest; 
    }
